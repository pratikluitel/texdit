...
class User extends Component{
    ...
    componentDidMount(){ 
        ...
        this.props.navigation.setOptions({
            headerTitle: this.state.user == ''?'User':'u/'+this.state.user,
        ...
        const user = (this.state.user.length !== 0? '/user/' : '')+this.state.user
                        ...
                        <View style={styles.modal}>
                            ...
                            style={styles.modalView}>
                                ...
                                style={styles.textBox}>
                                    <TextInput
                                    onChangeText={(tempuser)=>this.setState({...this.state, tempuser: tempuser})}
                                ...
                                style={{ flexDirection: 'row'}}>
                                    <Button 
                                        ...
                                        onPress={()=>this.setState({...this.state, 
                                            user: this.state.tempuser, tempuser:'', 
                                            posts:{...this.state.posts, isLoading: true}},
                                        ()=>this.toggleModal())}/>
                                    <Button 
                                        title='cancel'
                                        style={styles.openButton}
